...
import { X, PenTool, Loader2, Plus, LayoutGrid } from 'lucide-react';
...
interface CreateWhiteboardModalProps {
  ...
  initialElements?: any[];
  onCreated: (wb: WhiteboardItem, templateElements?: any[]) => void;
}
...
export function CreateWhiteboardModal({
  ...
  }, [isOpen, defaultWorkspaceId, defaultProjectId, initialTitle, initialDescription, activeWorkspace, workspaces]);
